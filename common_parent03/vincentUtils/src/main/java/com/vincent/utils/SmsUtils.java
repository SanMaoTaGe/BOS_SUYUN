...
public class SmsUtils {
 ...
 static final String accessKeyId = "LTAIYdUb2j5RQe9g";
 static final String accessKeySecret = "BDODv8EbPpZxC9x42s79rN9lPn1ZA2";
 ...
 public static SendSmsResponse sendSms(String telephone, String code)
  ...
  // 必填:短信签名-可在短信控制台中找到
  request.setSignName("长风");
  // 必填:短信模板-可在短信控制台中找到
  request.setTemplateCode("SMS_128520115");
 ...
 public static QuerySendDetailsResponse querySendDetails(String bizId)
  ...
  // 必填-号码
  request.setPhoneNumber("13692280056");
  // 可选-流水号
